...
void TM_ILI9341_InitLCD(void) {
	...
	TM_ILI9341_SendData(0x39); // Idle_mode_off
	TM_ILI9341_SendData(0x2C); // Memory write
	TM_ILI9341_SendData(0x00); // NOP
	TM_ILI9341_SendData(0x34); // Tearing effect line off 
	TM_ILI9341_SendData(0x02);
	TM_ILI9341_SendCommand(ILI9341_POWERB);
	TM_ILI9341_SendData(0x00); // NOP
	TM_ILI9341_SendData(0xC1); // power control 1
	TM_ILI9341_SendData(0x30); // Partial area
	TM_ILI9341_SendCommand(ILI9341_DTCA);// driver timing control A
	TM_ILI9341_SendData(0x85);
	TM_ILI9341_SendData(0x00); // NOP
	TM_ILI9341_SendData(0x78);
	TM_ILI9341_SendCommand(ILI9341_DTCB); // driver timing control B
	TM_ILI9341_SendData(0x00); // NOP
	TM_ILI9341_SendData(0x00); // NOP
	TM_ILI9341_SendCommand(ILI9341_POWER_SEQ); //POWER_ON_SEQUENCE_CONTROL
	TM_ILI9341_SendData(0x64);
	TM_ILI9341_SendData(0x03);
	TM_ILI9341_SendData(0x12); // partial mode on 
	TM_ILI9341_SendData(0x81);
	TM_ILI9341_SendCommand(ILI9341_PRC);// Pump ratio control
	TM_ILI9341_SendData(0x20);// Display Inversion OFF
	TM_ILI9341_SendCommand(ILI9341_POWER1); // power control 1
	TM_ILI9341_SendData(0x23);
	TM_ILI9341_SendCommand(ILI9341_POWER2); // power control 2
	TM_ILI9341_SendData(0x10);
	TM_ILI9341_SendCommand(ILI9341_VCOM1); // VCOM Control 1
	TM_ILI9341_SendData(0x3E);
	TM_ILI9341_SendData(0x28);
	TM_ILI9341_SendCommand(ILI9341_VCOM2);// VCOM Control 2
	TM_ILI9341_SendData(0x86);
	TM_ILI9341_SendCommand(ILI9341_MAC); // Memory Access Control
	TM_ILI9341_SendData(0x48);
	TM_ILI9341_SendCommand(ILI9341_PIXEL_FORMAT); // COLMOD: Pixel Format Set
	TM_ILI9341_SendData(0x55);
	TM_ILI9341_SendCommand(ILI9341_FRC); // Frame Rate Control (In Normal Mode/Full Colors
	TM_ILI9341_SendData(0x00);
	TM_ILI9341_SendData(0x18);
	TM_ILI9341_SendCommand(ILI9341_DFC); // Display function control
	TM_ILI9341_SendData(0x08);
	TM_ILI9341_SendData(0x82);
	TM_ILI9341_SendData(0x27);
	TM_ILI9341_SendCommand(ILI9341_3GAMMA_EN);// Enable 3G
	TM_ILI9341_SendData(0x00);
	TM_ILI9341_SendCommand(ILI9341_COLUMN_ADDR); // Column Address Set
	TM_ILI9341_SendData(0x00);
	TM_ILI9341_SendData(0x00);
	TM_ILI9341_SendData(0x00);
	TM_ILI9341_SendData(0xEF);
	TM_ILI9341_SendCommand(ILI9341_PAGE_ADDR);// Page Address Set
	TM_ILI9341_SendData(0x00);
	TM_ILI9341_SendData(0x00); 
	TM_ILI9341_SendData(0x01);
	TM_ILI9341_SendData(0x3F);
	TM_ILI9341_SendCommand(ILI9341_GAMMA); // Gamma Set
	TM_ILI9341_SendData(0x01);
	TM_ILI9341_SendCommand(ILI9341_PGAMMA);// Positive Gamma Correction
	...
	TM_ILI9341_SendData(0x00);
	TM_ILI9341_SendCommand(ILI9341_NGAMMA);// Negative Gamma Correction
	TM_ILI9341_SendData(0x00);
	TM_ILI9341_SendData(0x0E);
	...
	TM_ILI9341_SendData(0x0F);
	TM_ILI9341_SendCommand(ILI9341_SLEEP_OUT); // Sleep Out

	TM_ILI9341_Delay(1000000);

	TM_ILI9341_SendCommand(ILI9341_DISPLAY_ON); // Display ON
	TM_ILI9341_SendCommand(ILI9341_GRAM);//Memory Write
}
